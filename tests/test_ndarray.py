...
def submit_ndarray_python_ops():
    Rand(4, 4).reshape((2, 2, 4))
    Rand(2, 2, 4).reshape((4, 4))
    Rand(1, 3, 2, 1, 2).permute((1, 3, 2, 0, 4))
    Rand(2, 1, 2).broadcast_to((2, 3, 2))
    Rand(1, 1, 2).broadcast_to((2, 2, 2))
    Rand(4, 4)[1, 0]
    Rand(4, 4)[1, 0:3]
    Rand(4, 4)[1:3, 0:3]
    Rand(4, 4, 4)[0:2, 1:3, 2:4]
    Rand(4, 4, 4)[0:4:2, :3, 2:]


def submit_ndarray_cpu_compact_setitem():
    Rand(4, 4, 4)[0:4:2, :3, 2:].compact()
    Rand(1, 3, 2, 1, 2).permute((1, 3, 2, 0, 4)).compact()
    Rand(1, 1, 2).broadcast_to((2, 2, 2)).compact()
    Rand(4, 4).reshape((2, 2, 4)).compact()
...
def submit_ndarray_cpu_reductions():
    Rand(4, 4).sum(axis=1)
    Rand(4, 4, 4).sum(axis=1)
    Rand(4).sum(axis=0)
    Rand(2, 2, 2, 4, 2).sum(axis=3)
    Rand(4, 4).max(axis=1)
    Rand(4, 4, 4).max(axis=1)
    Rand(4).max(axis=0)
    Rand(2, 2, 2, 4, 2).max(axis=3)
...
def submit_ndarray_cuda_compact_setitem():
    RandC(4, 4, 4)[0:4:2, :3, 2:].compact()
    RandC(1, 3, 2, 1, 2).permute((1, 3, 2, 0, 4)).compact()
    RandC(1, 1, 2).broadcast_to((2, 2, 2)).compact()
    RandC(4, 4).reshape((2, 2, 4)).compact()
...
def submit_ndarray_cuda_reductions():
    RandC(4, 4).sum(axis=1)
    RandC(4, 4, 4).sum(axis=1)
    RandC(4).sum(axis=0)
    RandC(2, 2, 2, 4, 2).sum(axis=3)
    RandC(4, 4).max(axis=1)
    RandC(4, 4, 4).max(axis=1)
    RandC(4).max(axis=0)
    RandC(2, 2, 2, 4, 2).max(axis=3)
